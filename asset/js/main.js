...
function searchTopper(){
    ...
    const headerSecondarySearchElement = document.querySelector(".js-header-second");
...
function clickSlide(){
    ...
    slidePageArr[0].onclick = () =>{
        slideEl.style = "transform: translate3d(0px, 0px, 0px); transition: all 1.25s ease 0s;";
    ...
    slidePageArr[1].onclick = () =>{
        slideEl.style = "transform: translate3d(-1200px, 0px, 0px); transition: all 1.25s ease 0s;";
        const slideActive = $(".slide-page__icon.active");
    ...
    slidePageArr[2].onclick = () =>{
        slideEl.style = "transform: translate3d(-2400px, 0px, 0px); transition: all 1.25s ease 0s;";
        const slideActive = $(".slide-page__icon.active");
